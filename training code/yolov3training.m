...
classes = gTruthData.LabelDefinitions(:,1);
classNames = table2cell(classes);
yolov3Detector = yolov3ObjectDetector(baseNetwork,classNames,anchorBoxes,'DetectionNetworkSource',{'fire9-concat', 'fire5-concat'});

%preprocessedTrainingData = transform(augmentedTrainingData2, @(data)preprocess(yolov3Detector, data));
