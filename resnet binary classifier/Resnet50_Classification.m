%% loading imaged from main folder
outputFolder = fullfile('ResNet50_Data');

% loading images from categories
categories = {'WearInserts','Residues'};
...
%% specifying weights of the first convolution layer(layer 2) and plotting the image 
...
featureLayer = 'fc1000';
trainingFeatures = activations(net1, augmentedTrainingSet, featureLayer,...
